...
template<typename T>
public inner_set_2(T p_element_1, T p_element_2)
{
...
template<typename T>
inner_set_2<T>::inner_set_2(T inner_set_1, T p_element)
{
            a_values.element_1 = i.element_1;                    a_values.element_2 = p_element;
}
...
inner_set<T>* inner_set_2<T>::remove_element(T p_element)
{
            ...
            return new inner_set_1<>(element_2);
         else             if(element_2 == p_element)
            return new inner_set_1<>(element_1);
                else
        return this;
}
