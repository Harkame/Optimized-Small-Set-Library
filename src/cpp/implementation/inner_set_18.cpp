...
inner_set_18<T, p_to_up>::inner_set_18()
{

}

template<typename T, int p_to_up>
inner_set_18<T, p_to_up>::inner_set_18(T p_element_1, T p_element_2, T p_element_3, T p_element_4, T p_element_5, T p_element_6, T p_element_7, T p_element_8, T p_element_9, T p_element_10, T p_element_11, T p_element_12, T p_element_13, T p_element_14, T p_element_15, T p_element_16, T p_element_17, T p_element_18)
{
...
inner_set<T, p_to_up>* inner_set_18<T, p_to_up>::remove_element(T p_element)
{
        	...
        	return new inner_set_17<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_9,  a_values.element_10,  a_values.element_11,  a_values.element_12,  a_values.element_13,  a_values.element_14,  a_values.element_15,  a_values.element_17,  a_values.element_18);
                ...
                {
        	delete this;
        	return new inner_set_17<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_9,  a_values.element_10,  a_values.element_11,  a_values.element_12,  a_values.element_13,  a_values.element_14,  a_values.element_15,  a_values.element_16,  a_values.element_18);
    	}
...
template<typename T, int p_to_up>
inner_set<T, p_to_up>* inner_set_18<T, p_to_up>::add_and_propagate(T p_element, micro_set<T, p_to_up>* p_micro_set)
{
...
template<typename T, int p_to_up>
inner_set<T, p_to_up>* inner_set_18<T, p_to_up>::add_all_and_propagate(inner_set<T, p_to_up>* p_inner_set, micro_set<T, p_to_up>* p_micro_set)
{
  return p_inner_set->add_all_and_propagate_reverse(this, p_micro_set);
}

template<typename T, int p_to_up>
inner_set<T, p_to_up>* inner_set_18<T, p_to_up>::add_all_and_propagate_reverse(inner_set<T, p_to_up>* p_inner_set, micro_set<T, p_to_up>* p_micro_set)
{
...
template<typename T, int p_to_up>
int inner_set_18<T, p_to_up>::get_size()
{
    return 18;
}
