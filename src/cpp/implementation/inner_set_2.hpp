...
class inner_set_2 : virtual public inner_set<T, p_to_up>
{
    public :
        struct values
        {
        ...
        inner_set_2<T, p_to_up>();
        inner_set_2<T, p_to_up>(T , T);
        inner_set_2<T, p_to_up>(inner_set_1<T, p_to_up>* , T);

        virtual ~inner_set_2<T, p_to_up>();
