#ifndef INNER_SET_19_HPP
#define INNER_SET_19_HPP
...
class inner_set_19 : public inner_set<T, p_to_up>
{
    public :
        struct values
        {
             T element_1;  T element_2;  T element_3;  T element_4;  T element_5;  T element_6;  T element_7;  T element_8;  T element_9;  T element_10;  T element_11;  T element_12;  T element_13;  T element_14;  T element_15;  T element_16;  T element_17;  T element_18;  T element_19;
        } a_values;

        inner_set_19<T, p_to_up>();
        inner_set_19<T, p_to_up>( T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T, T);
        inner_set_19<T, p_to_up>(inner_set_18<T, p_to_up>*, T);

        virtual inner_set<T, p_to_up>* copy();

        virtual ~inner_set_19<T, p_to_up>();
