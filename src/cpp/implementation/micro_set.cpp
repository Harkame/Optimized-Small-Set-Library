...
template<typename T, int p_to_up>
iterator_micro_set<T, p_to_up> micro_set<T, p_to_up>::begin() const
{
	return iterator_micro_set<T, p_to_up>(a_inner_set);
}

template<typename T, int p_to_up>
iterator_micro_set<T, p_to_up>  micro_set<T, p_to_up>::end() const
{
...
template<typename T, int p_to_up>
iterator_micro_set<T, p_to_up> micro_set<T, p_to_up>::find(T p_element) const
{
	iterator_micro_set<T, p_to_up> r_iterator_micro_set(a_inner_set);
...
template<typename T, int p_to_up>
bool micro_set<T, p_to_up>::empty() const
{
    return a_inner_set->get_size() == 0;
}

template<typename T, int p_to_up>
int micro_set<T, p_to_up>::size() const
{
...
template<typename T, int p_to_up>
void micro_set<T, p_to_up>::insert_all(micro_set<T, p_to_up> p_micro_set)
{
	a_inner_set = p_micro_set.a_inner_set->add_all_elements(a_inner_set);
}

template<typename T, int p_to_up>
void micro_set<T, p_to_up>:: erase(T p_element)
{
	a_inner_set = a_inner_set->remove_element(p_element);
}

template<typename T, int p_to_up>
void micro_set<T, p_to_up>::erase_all(micro_set<T, p_to_up> p_micro_set)
{
	a_inner_set = p_micro_set.a_inner_set->remove_all_elements(a_inner_set);
}

template<typename T, int p_to_up>
void micro_set<T, p_to_up>::retain_all(micro_set<T, p_to_up> p_micro_set)
{
...
template<typename T, int p_to_up>
bool  operator==(const micro_set<T, p_to_up> p_micro_set_a, const micro_set<T, p_to_up> p_micro_set_b)
{
	return true;
}
