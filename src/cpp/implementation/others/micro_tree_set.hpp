...
class micro_tree_set :  micro_set<T, p_to_up>
{
    private:
  ...
  public:
      ...
      virtual void insert_all(micro_tree_set<T, p_to_up>);

      virtual void erase(T);

      virtual void erase_all(micro_tree_set<T, p_to_up>);

      virtual void retain_all(micro_tree_set<T, p_to_up>);

      virtual void clear();

      /* Custom */
      virtual micro_tree_set<T, p_to_up>* add_all_and_propagate(micro_tree_set<T, p_to_up>);
