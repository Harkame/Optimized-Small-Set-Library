...
inner_set<T, p_to_up>* inner_set_10<T, p_to_up>::remove_element(T p_element)
{
                ...
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_9,  a_values.element_10);
    	}
         else                 if(a_values.element_2 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_9,  a_values.element_10);
    	}
         else                 if(a_values.element_3 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_9,  a_values.element_10);
    	}
         else                 if(a_values.element_4 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_9,  a_values.element_10);
    	}
         else                 if(a_values.element_5 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_9,  a_values.element_10);
    	}
         else                 if(a_values.element_6 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_7,  a_values.element_8,  a_values.element_9,  a_values.element_10);
    	}
         else                 if(a_values.element_7 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_8,  a_values.element_9,  a_values.element_10);
    	}
         else                 if(a_values.element_8 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_9,  a_values.element_10);
    	}
         else                 if(a_values.element_9 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_10);
    	}
         else                 if(a_values.element_10 == p_element)
                {
        	delete this;
        	return new inner_set_9<T, p_to_up>( a_values.element_1,  a_values.element_2,  a_values.element_3,  a_values.element_4,  a_values.element_5,  a_values.element_6,  a_values.element_7,  a_values.element_8,  a_values.element_9);
    	}
                        else
            return this;
}
...
template<typename T, int p_to_up>
int inner_set_10<T, p_to_up>::get_size()
{
    return 10;
}
