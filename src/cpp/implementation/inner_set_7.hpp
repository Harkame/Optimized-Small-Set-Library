#ifndef INNER_SET_7_HPP
#define INNER_SET_7_HPP
...
class inner_set_7 : public inner_set<T, p_to_up>
{
    public :
        struct values
        {
        ...
        inner_set_7<T, p_to_up>();
        inner_set_7<T, p_to_up>( T, T, T, T, T, T, T);
        inner_set_7<T, p_to_up>(inner_set_6<T, p_to_up>*, T);

        virtual inner_set<T, p_to_up>* copy();

        virtual ~inner_set_7<T, p_to_up>();
