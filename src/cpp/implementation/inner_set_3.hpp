...
class inner_set_3 : virtual public inner_set<T, p_to_up>
{
    public :
        struct values
        {
        ...
        inner_set_3<T, p_to_up>();
        inner_set_3<T, p_to_up>(T , T , T );
        inner_set_3<T, p_to_up>(inner_set_2<T, p_to_up>*, T);

        virtual ~inner_set_3<T, p_to_up>();
