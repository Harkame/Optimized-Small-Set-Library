...
class inner_tree_set : virtual public inner_set<T, p_to_up>, virtual public set<T>
{
    public :
        inner_tree_set<T, p_to_up>();

        inner_tree_set<T, p_to_up>(inner_set<T, p_to_up>*);

        inner_tree_set<T, p_to_up>(inner_set<T, p_to_up>*, T);

        virtual ~inner_tree_set<T, p_to_up>();
