...
inner_set<T, p_to_up>* inner_set_3<T, p_to_up>::remove_element(T p_element)
{
                ...
                {
        	delete this;
        	return new inner_set_2<T, p_to_up>(a_values.element_2a_values.element_3);
    	}
         else                 if(a_values.element_2 == p_element)
                {
        	delete this;
        	return new inner_set_2<T, p_to_up>(a_values.element_1a_values.element_3);
    	}
         else                 if(a_values.element_3 == p_element)
                {
        	delete this;
        	return new inner_set_2<T, p_to_up>(a_values.element_1a_values.element_2);
    	}
                        else
            return this;
}
