#ifndef INNER_SET_14_HPP
#define INNER_SET_14_HPP
...
class inner_set_14 : public inner_set<T, p_to_up>
{
    public :
        struct values
        {
             T element_1;  T element_2;  T element_3;  T element_4;  T element_5;  T element_6;  T element_7;  T element_8;  T element_9;  T element_10;  T element_11;  T element_12;  T element_13;  T element_14;
        } a_values;

        inner_set_14<T, p_to_up>();
        inner_set_14<T, p_to_up>( T, T, T, T, T, T, T, T, T, T, T, T, T, T);
        inner_set_14<T, p_to_up>(inner_set_13<T, p_to_up>*, T);

        virtual inner_set<T, p_to_up>* copy();

        virtual ~inner_set_14<T, p_to_up>();
