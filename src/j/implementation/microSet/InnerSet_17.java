...
public class InnerSet_17 <T> extends AbstractInnerSet<T>
{
    ...
    public InnerSet_17(InnerSet_17<T> i)
    {
    ...
    public InnerSet_17<T> copy() {
        return new InnerSet_17(this);
    }
