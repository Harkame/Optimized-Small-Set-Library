...
public class InnerSet_13 <T> extends AbstractInnerSet<T>
{
    ...
    public InnerSet_13(InnerSet_13<T> i)
    {
    ...
    public InnerSet_13<T> copy() {
        return new InnerSet_13(this);
    }
    ...
    public InnerSet<T> addAllElements(InnerSet<T> innerSet) {
        return innerSet.addElement(element_1).addElement(element_2).addElement(element_3).addElement(element_4).addElement(element_5).addElement(element_6).addElement(element_7).addElement(element_8).addElement(element_9).addElement(element_10).addElement(element_11).addElement(element_12).addElement(element_13);
    }
