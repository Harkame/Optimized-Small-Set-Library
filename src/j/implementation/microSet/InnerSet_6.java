...
public class InnerSet_6 <T> extends AbstractInnerSet<T>
{
    ...
    public InnerSet<T> addAllAndPropagate(InnerSet<T> innerSet, MicroSet<T> microSet) {
        return innerSet.addAndPropagate(element_1, microSet).addAndPropagate(element_2, microSet).addAndPropagate(element_3, microSet).addAndPropagate(element_4, microSet).addAndPropagate(element_5, microSet).addAndPropagate(element_6, microSet);
    }
