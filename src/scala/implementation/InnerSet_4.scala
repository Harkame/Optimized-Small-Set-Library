...
class InnerSet_4[T](element1: T, element2: T, element3: T, element4: T) extends AbstractInnerSet[T]
{
    ...
    override def containsAllElements(p_innerSet: InnerSet[T]): Boolean =  p_innerSet.containsElement(element1) && p_innerSet.containsElement(element2) && p_innerSet.containsElement(element3) && p_innerSet.containsElement(element4)
