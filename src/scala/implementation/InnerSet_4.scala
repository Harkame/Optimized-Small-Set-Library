...
class InnerSet_4[T](element1: T, element2: T, element3: T, element4: T) extends InnerSet[T]
{
    ...
    override def addElement(p_element: T): InnerSet[T] =
    {
        ...
        else  new InnerSet_5(element1element2element3element4, p_element)
    }

    override def addUnchecked(p_element: T): InnerSet[T] = InnerSet_5(element1, p_element)element2, p_element)element3, p_element)element4, p_element)

    override def addAllElements(p_innerSet: InnerSet[T]): InnerSet[T] =     {
                p_innerSet.addElement(element1)        p_innerSet.addElement(element2)        p_innerSet.addElement(element3)        p_innerSet.addElement(element4)    }
    ...
    override def removeElement(p_element: T): InnerSet[T] =
    {
            if(element1.equals(p_element)){
             new InnerSet_3(element2, element3, element4)                     if(element2.equals(p_element)){
             new InnerSet_3(element1, element3, element4)                     if(element3.equals(p_element)){
             new InnerSet_3(element1, element2, element4)                     if(element4.equals(p_element)){
    ...
    override def removeAllElements(p_innerSet: InnerSet[T]): InnerSet[T] =     {
                p_innerSet.removeElement(element1)        p_innerSet.removeElement(element2)        p_innerSet.removeElement(element3)        p_innerSet.removeElement(element4)    }

    override def retainAllElements(p_innerSet: InnerSet[T]): InnerSet[T] =
    {
      var i: InnerSet[T] = this
            if(!p_innerSet.containsElements(element1)) i = i.removeElement(element1)      if(!p_innerSet.containsElements(element2)) i = i.removeElement(element2)      if(!p_innerSet.containsElements(element3)) i = i.removeElement(element3)      if(!p_innerSet.containsElements(element4)) i = i.removeElement(element4)      i
    }
