...
class InnerSet_15[T](protected val element1: T, protected val element2: T, protected val element3: T, protected val element4: T, protected val element5: T, protected val element6: T, protected val element7: T, protected val element8: T, protected val element9: T, protected val element10: T, protected val element11: T, protected val element12: T, protected val element13: T, protected val element14: T, protected val element15: T) extends AbstractInnerSet[T]
{

    def this(p_innerSet: InnerSet_15[T]) = this(p_innerSet.element1 , p_innerSet.element2 , p_innerSet.element3 , p_innerSet.element4 , p_innerSet.element5 , p_innerSet.element6 , p_innerSet.element7 , p_innerSet.element8 , p_innerSet.element9 , p_innerSet.element10 , p_innerSet.element11 , p_innerSet.element12 , p_innerSet.element13 , p_innerSet.element14 , p_innerSet.element15 )
    override def addElement(p_element: T): InnerSet[T] =
    {
        if (element1.equals(p_element) || element2.equals(p_element) || element3.equals(p_element) || element4.equals(p_element) || element5.equals(p_element) || element6.equals(p_element) || element7.equals(p_element) || element8.equals(p_element) || element9.equals(p_element) || element10.equals(p_element) || element11.equals(p_element) || element12.equals(p_element) || element13.equals(p_element) || element14.equals(p_element) || element15.equals(p_element))
        {
            this
        }
        else  new InnerSet_16(element1, element2, element3, element4, element5, element6, element7, element8, element9, element10, element11, element12, element13, element14, element15, p_element)
    }

    override def addUnchecked(p_element: T): InnerSet[T] =  new InnerSet_16(element1, element2, element3, element4, element5, element6, element7, element8, element9, element10, element11, element12, element13, element14, element15, p_element)

    override def addAllElements(p_innerSet: InnerSet[T]): InnerSet[T] =  p_innerSet .addElement(element1) .addElement(element2) .addElement(element3) .addElement(element4) .addElement(element5) .addElement(element6) .addElement(element7) .addElement(element8) .addElement(element9) .addElement(element10) .addElement(element11) .addElement(element12) .addElement(element13) .addElement(element14) .addElement(element15)
    ...
    override def removeElement(p_element: Object): InnerSet[T] =
    {
         ...
         new InnerSet_14(element2, element3, element4, element5, element6, element7, element8, element9, element10, element11, element12, element13, element14, element15)
                  else             if(element2.equals(p_element))
         new InnerSet_14(element1, element3, element4, element5, element6, element7, element8, element9, element10, element11, element12, element13, element14, element15)
                  else             if(element3.equals(p_element))
         new InnerSet_14(element1, element2, element4, element5, element6, element7, element8, element9, element10, element11, element12, element13, element14, element15)
                  else             if(element4.equals(p_element))
         new InnerSet_14(element1, element2, element3, element5, element6, element7, element8, element9, element10, element11, element12, element13, element14, element15)
                  else             if(element5.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element6, element7, element8, element9, element10, element11, element12, element13, element14, element15)
                  else             if(element6.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element7, element8, element9, element10, element11, element12, element13, element14, element15)
                  else             if(element7.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element8, element9, element10, element11, element12, element13, element14, element15)
                  else             if(element8.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element7, element9, element10, element11, element12, element13, element14, element15)
                  else             if(element9.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element7, element8, element10, element11, element12, element13, element14, element15)
                  else             if(element10.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element7, element8, element9, element11, element12, element13, element14, element15)
                  else             if(element11.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element7, element8, element9, element10, element12, element13, element14, element15)
                  else             if(element12.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element7, element8, element9, element10, element11, element13, element14, element15)
                  else             if(element13.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element7, element8, element9, element10, element11, element12, element14, element15)
                  else             if(element14.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element7, element8, element9, element10, element11, element12, element13, element15)
                  else             if(element15.equals(p_element))
         new InnerSet_14(element1, element2, element3, element4, element5, element6, element7, element8, element9, element10, element11, element12, element13, element14)
                            else this
    }
    ...
    override def toString : String = "{ " + element1 + ", " + element2 + ", " + element3 + ", " + element4 + ", " + element5 + ", " + element6 + ", " + element7 + ", " + element8 + ", " + element9 + ", " + element10 + ", " + element11 + ", " + element12 + ", " + element13 + ", " + element14 + ", " + element15 + " }"
    ...
    override def addAndPropagate(p_element: T, p_microSet: MicroSet[T]): InnerSet[T] =
    {
        if (element1.equals(p_element) || element2.equals(p_element) || element3.equals(p_element) || element4.equals(p_element) || element5.equals(p_element) || element6.equals(p_element) || element7.equals(p_element) || element8.equals(p_element) || element9.equals(p_element) || element10.equals(p_element) || element11.equals(p_element) || element12.equals(p_element) || element13.equals(p_element) || element14.equals(p_element) || element15.equals(p_element))
        {
            ...
            new InnerSet_16(element1, element2, element3, element4, element5, element6, element7, element8, element9, element10, element11, element12, element13, element14, element15, p_element)
        }    }
    ...
    override def addAllAndPropagateReverse(p_innerSet: InnerSet[T], p_microSet: MicroSet[T]): InnerSet[T] =  p_innerSet .addAndPropagate(element1,p_microSet) .addAndPropagate(element2,p_microSet) .addAndPropagate(element3,p_microSet) .addAndPropagate(element4,p_microSet) .addAndPropagate(element5,p_microSet) .addAndPropagate(element6,p_microSet) .addAndPropagate(element7,p_microSet) .addAndPropagate(element8,p_microSet) .addAndPropagate(element9,p_microSet) .addAndPropagate(element10,p_microSet) .addAndPropagate(element11,p_microSet) .addAndPropagate(element12,p_microSet) .addAndPropagate(element13,p_microSet) .addAndPropagate(element14,p_microSet) .addAndPropagate(element15,p_microSet)
}