...
class InnerSet_8[T](protected val element1: T, protected val element2: T, protected val element3: T, protected val element4: T, protected val element5: T, protected val element6: T, protected val element7: T, protected val element8: T) extends AbstractInnerSet[T]
{
    ...
    override def addElement(p_element: T): InnerSet[T] =
    {
        ...
        else  new InnerSet_9(element1, element2, element3, element4, element5, element6, element7, element8, p_element)
    }

    override def addUnchecked(p_element: T): InnerSet[T] =  new InnerSet_9(element1, element2, element3, element4, element5, element6, element7, element8, p_element)
    ...
    override def removeElement(p_element: Object): InnerSet[T] =
    {
         ...
         new InnerSet_7(element2, element3, element4, element5, element6, element7, element8)
                  else             if(element2.equals(p_element))
         new InnerSet_7(element1, element3, element4, element5, element6, element7, element8)
                  else             if(element3.equals(p_element))
         new InnerSet_7(element1, element2, element4, element5, element6, element7, element8)
                  else             if(element4.equals(p_element))
         new InnerSet_7(element1, element2, element3, element5, element6, element7, element8)
                  else             if(element5.equals(p_element))
         new InnerSet_7(element1, element2, element3, element4, element6, element7, element8)
                  else             if(element6.equals(p_element))
         new InnerSet_7(element1, element2, element3, element4, element5, element7, element8)
                  else             if(element7.equals(p_element))
         new InnerSet_7(element1, element2, element3, element4, element5, element6, element8)
    ...
    override def addAndPropagate(p_element: T, p_microSet: MicroSet[T]): InnerSet[T] =
    {
        if (element1.equals(p_element) || element2.equals(p_element) || element3.equals(p_element) || element4.equals(p_element) || element5.equals(p_element) || element6.equals(p_element) || element7.equals(p_element) || element8.equals(p_element))
        {
            ...
            new InnerSet_9(element1, element2, element3, element4, element5, element6, element7, element8, p_element)
        }    }
