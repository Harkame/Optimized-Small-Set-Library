...
class InnerSet_19[T](protected val element1: T, protected val element2: T, protected val element3: T, protected val element4: T, protected val element5: T, protected val element6: T, protected val element7: T, protected val element8: T, protected val element9: T, protected val element10: T, protected val element11: T, protected val element12: T, protected val element13: T, protected val element14: T, protected val element15: T, protected val element16: T, protected val element17: T, protected val element18: T, protected val element19: T) extends AbstractInnerSet[T]
{
    ...
    override def removeElement(p_element: Object): InnerSet[T] =
    {
            if(element1.equals(p_element))
                ...
                if(element13.equals(p_element))
                if(element14.equals(p_element))
                if(element15.equals(p_element))
                if(element16.equals(p_element))
                if(element17.equals(p_element))
                if(element18.equals(p_element))
                if(element19.equals(p_element))
